...
if ($results) {
	...
	echo "</table>";
echo "<h2 style='text-align:center'>Display Music Records</h2>";
echo "<table border='1' width='75%' cellspacing='2' cellpadding='2' align='center'>";
echo "<tr align='center' valign='top'>";
echo "<td align='center' valign='top'><b>BAND TITLE</b></td>";
echo "<td align='center' valign='top'><b>ALBUM TITLE</b></td>";
echo "<td align='center' valign='top'><b>PRODUCTION COMPANY</b></td>";
echo "<td align='center' valign='top'><b>YEAR RELEASED</b></td>";
echo "</tr>";
$results = Music::retrieveAllRecords($dbc); 
if ($results) {
	foreach($results as $Row) {
		echo "<tr align='center' valign='top'>";
		echo "<td align='center' valign='top'><b>$Row[Title]</b></td>";
		echo "<td align='center' valign='top'><b>$Row[Album]</b></td>";
		echo "<td align='center' valign='top'><b>$Row[ProductionCompany]</b></td>";
		echo "<td align='center' valign='top'>$Row[YearReleased]</b></td>";
		echo "</tr>";
		} 
	}	else {
		echo "<tr align='center'>";
