...
class Movie extends Media{
	...
	public function updateRecord($dbc) {
		$query = "UPDATE Movies SET Title = '$this->title', "."ProductionCompany = '$this->productionCompany', "."yearReleased = 'this->YearReleased', "."Director = '$this->director' WHERE id = '$this->id' ";
		$result = $dbc->sqlQuery($query); 
		return $result; 
	}
